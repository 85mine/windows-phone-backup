...
namespace STOP_Music.Controller
{
    internal class Controls
    {
        ...
        public static void GetProVersion(string appId)
        {
            if (MessageBox.Show("Sorry, this feature only available on DONATE version. Would you like get it ?",
                        "DONATE", MessageBoxButton.OKCancel) == MessageBoxResult.OK)
            {
                MarketplaceDetailTask donate_pro = new MarketplaceDetailTask();
                donate_pro.ContentIdentifier = appId;
